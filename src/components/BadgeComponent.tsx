...
export const BadgeList: React.FC<BadgeListProps> = ({ 
  ...
  console.log('🏆 BadgeList - badges type:', typeof badges, 'value:', badges);
  console.log('🏆 BadgeList - badgeProgress type:', typeof badgeProgress, 'value:', badgeProgress);
  
  // More robust safety checks
  const safeBadges = Array.isArray(badges) ? badges : [];
  const safeBadgeProgress = Array.isArray(badgeProgress) ? badgeProgress : [];
  
  const earnedBadges = safeBadges.slice(0, maxVisible);
  const inProgressBadges = safeBadgeProgress
